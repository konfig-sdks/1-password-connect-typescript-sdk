...
/**
 * This class provides a wrapper for network errors when making requests to 1Password Connect
 */
export class OnePasswordConnectError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "OnePasswordConnectError";
